...
class Snatching_Complain extends StatelessWidget {
  const Snatching_Complain({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextField(
                    autofocus: true,
                    decoration: InputDecoration(
                        hintText: "Snatching Item Detail",
                        focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(50),
                            borderSide: BorderSide(
                                width: 2, color: Colors.red.shade700))),
                ...
                Container(
                  ...
                  child: TextField(
                    autofocus: true,
                    decoration: InputDecoration(
                        hintText: "Location where it happen",
                        focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(50),
                            borderSide: BorderSide(
                                width: 2, color: Colors.red.shade700))),
